...
class TestConfiguration(TestBase):
    def test_config(self):
        ...
        self.assertEqual(
            application.services["TEST_TEMPLATE"]["anestedvalue"]["anotherunique"], "value",
        )
        self.assertEqual(
            application.services["TEST_TEMPLATE"]["anestedvalue"]["new"], "and this value",
        )
        self.assertEqual(
            application.services["TEST_TEMPLATE"]["anestedvalue"]["override"], "will have this value",
        )
